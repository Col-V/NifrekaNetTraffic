...
namespace NifrekaNetTraffic
{
    ...
    {
        public const string NifrekaNet_Version= "1.3";
        public const int NifrekaNet_Build = 45;
        ...
        // remove _Old_pre44 data files
        public const string NifrekaNetTraffic_Settings_Filename_Old_pre44 = "NifrekaNetTraffic_Settings.nntDATA";
        public static string NifrekaNetTraffic_Settings_partialPath_Old_pre44 = NifrekaNetTraffic_foldername + @"\" + NifrekaNetTraffic_Data_foldername + @"\" + NifrekaNetTraffic_Settings_Filename_Old_pre44;
        public static string NifrekaNetTraffic_Settings_PATH_Old_pre44 = Environment.GetFolderPath(Environment.SpecialFolder.MyDoc‌​uments) + @"\" + NifrekaNetTraffic_Settings_partialPath_Old_pre44;

        public const string NifrekaNetTraffic_Log_Filename_Old_pre44 = "NifrekaNetTraffic_Log.nntDATA";
        public static string NifrekaNetTraffic_Log_partialPath_Old_pre44 = NifrekaNetTraffic_foldername + @"\" + NifrekaNetTraffic_Data_foldername + @"\" + NifrekaNetTraffic_Log_Filename_Old_pre44;
        public static string NifrekaNetTraffic_Log_PATH_Old_pre44 = Environment.GetFolderPath(Environment.SpecialFolder.MyDoc‌​uments) + @"\" + NifrekaNetTraffic_Log_partialPath_Old_pre44;

        // new 44 data files ============================================
        public const string NifrekaNetTraffic_Settings_Filename = "NifrekaNetTraffic_Settings.nnt44DATA";
        ...
        public const string NifrekaNetTraffic_Log_Filename = "NifrekaNetTraffic_Log.nnt44DATA";
